...
?>
		...
		<div class="contact__container">
			<div class="contact__inner">
				...
				<div class="contact__description">
					<p>ルーフギャラリー カスタマーサポートの営業時間は、平日10:00 ～ 17:30（土日祝・年末年始を除く）です。</p>
					<p>いただいたお問い合わせは翌営業日以降、順次ご回答させていただきます。</p>
				</div>
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		function populateConfirm() {
			document.getElementById('js-confirm-content').textContent = getFieldValue('your-content');
